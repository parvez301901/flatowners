            ...
            <div class="row">
                <div class="col-lg-8 col-12">
                    ...
                    <div class="box">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('utility.store') }}">
                            @csrf
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" class="form-control" required="required" placeholder="Utility Name">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer d-flex justify-content-between">
                                ...
                                <input type="submit" class="btn btn-rounded btn-info" value="Add Utility">
                            </div>
                        </form>
                    </div>
                    <!-- /.box -->
