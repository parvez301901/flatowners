            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    ...
                    <div class="box">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('floor.update', $detailData->id) }}">
                            @csrf
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" value="{{$detailData->name}}" class="form-control" required="required" placeholder="Floor Name">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer d-flex justify-content-between">
                                ...
                                <input type="submit" class="btn btn-rounded btn-info" value="Update Floor">
                            </div>
                        </form>
                    </div>
                    <!-- /.box -->
