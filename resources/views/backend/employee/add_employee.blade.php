                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="join_date" type="date" class="form-control" placeholder="Salary">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Resignation Date</label>
                                            <input name="resignation_date" type="date" class="form-control" placeholder="Joining Date">
                                        </div>
                                    </div>
                                </div>
