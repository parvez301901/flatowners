...
class BanglaNumber
{
    ...
    protected static  $bn_num = array('শূন্য', 'এক', 'দুই', 'তিন', 'চার', 'পাঁচ', 'ছয়', 'সাত', 'আট', 'নয়');

    protected static  $bn_month = array(
                                    '1' => 'জানুয়ারি',
                                    '2' => 'ফেব্রুয়ারি',
                                    '3' => 'মার্চ',
                                    '4' => 'এপ্রিল',
    ...
    protected static $numbers = array('০','১','২','৩','৪','৫','৬','৭','৮','৯');
    ...
    public static  function bnWord($num)
    {
        ...
        if(floatval($num) == $num){
            ...
            if(isset($decimal[1]) && $decimal[1] > 0){
                $text .= ' দশমিক '.self::numToDecimalWord((string)$decimal[1]);
            }
            return $text;
        }else{
    ...
    protected  function checkValid($num)
    {
        if(!is_numeric($num)){
            return false;
        }
